...
static const elem_t conv_1_w_yololite1[27][(64)] row_align(MAX_BLOCK_LEN);// =
static const acc_t conv_1_b_yololite1[64] row_align_acc(MAX_BLOCK_LEN_ACC);// = {
static elem_t conv_1_out_yololite1[50176][(64)] row_align(MAX_BLOCK_LEN);
static elem_t conv_1_out_yololite1_pooled[1][112][112][(64)] row_align(MAX_BLOCK_LEN);
static const struct ConvParams conv_1_params_yololite1 = {.batch_size=1, .in_dim=224, .kernel_size=3, .in_channels=3, .out_channels=64, .out_stride=(64), .stride=1, .padding=1, .bias=1, .depthwise=0, .out_dim=224, .pool_size=2, .pool_stride=2, .pool_padding=0, .out_dim_pooled=112, .output_scale=10, .res_scale=0};


static const elem_t conv_2_w_yololite1[144][(64)] row_align(MAX_BLOCK_LEN);// =
static const acc_t conv_2_b_yololite1[64] row_align_acc(MAX_BLOCK_LEN_ACC);// = {
static elem_t conv_2_out_yololite1[12544][(64)] row_align(MAX_BLOCK_LEN);
static elem_t conv_2_out_yololite1_pooled[1][56][56][(64)] row_align(MAX_BLOCK_LEN);
static const struct ConvParams conv_2_params_yololite1 = {.batch_size=1, .in_dim=112, .kernel_size=3, .in_channels=64, .out_channels=64, .out_stride=(64), .stride=1, .padding=1, .bias=1, .depthwise=0, .out_dim=112, .pool_size=2, .pool_stride=2, .pool_padding=0, .out_dim_pooled=56, .output_scale=6, .res_scale=0};
...
static const struct ConvParams conv_3_params_yololite1 = {.batch_size=1, .in_dim=56, .kernel_size=3, .in_channels=64, .out_channels=64, .out_stride=64, .stride=1, .padding=1, .bias=1, .depthwise=0, .out_dim=56, .pool_size=2, .pool_stride=2, .pool_padding=0, .out_dim_pooled=28, .output_scale=7, .res_scale=0};
...
static const elem_t conv_1_w_yololite11[27][(64)] row_align(MAX_BLOCK_LEN);// =
static const acc_t conv_1_b_yololite11[64] row_align_acc(MAX_BLOCK_LEN_ACC);// = {
static elem_t conv_1_out_yololite11[50176][(64)] row_align(MAX_BLOCK_LEN);
static elem_t conv_1_out_yololite11_pooled[1][112][112][(64)] row_align(MAX_BLOCK_LEN);
static const struct ConvParams conv_1_params_yololite11 = {.batch_size=1, .in_dim=224, .kernel_size=3, .in_channels=3, .out_channels=64, .out_stride=(64), .stride=1, .padding=1, .bias=1, .depthwise=0, .out_dim=224, .pool_size=2, .pool_stride=2, .pool_padding=0, .out_dim_pooled=112, .output_scale=10, .res_scale=0};


static const elem_t conv_2_w_yololite11[144][(64)] row_align(MAX_BLOCK_LEN);// =
static const acc_t conv_2_b_yololite11[64] row_align_acc(MAX_BLOCK_LEN_ACC);// = {
static elem_t conv_2_out_yololite11[12544][(64)] row_align(MAX_BLOCK_LEN);
static elem_t conv_2_out_yololite11_pooled[1][56][56][(64)] row_align(MAX_BLOCK_LEN);
static const struct ConvParams conv_2_params_yololite11 = {.batch_size=1, .in_dim=112, .kernel_size=3, .in_channels=64, .out_channels=64, .out_stride=(64), .stride=1, .padding=1, .bias=1, .depthwise=0, .out_dim=112, .pool_size=2, .pool_stride=2, .pool_padding=0, .out_dim_pooled=56, .output_scale=6, .res_scale=0};
...
static const struct ConvParams conv_3_params_yololite11 = {.batch_size=1, .in_dim=56, .kernel_size=3, .in_channels=64, .out_channels=64, .out_stride=64, .stride=1, .padding=1, .bias=1, .depthwise=0, .out_dim=56, .pool_size=2, .pool_stride=2, .pool_padding=0, .out_dim_pooled=28, .output_scale=7, .res_scale=0};
